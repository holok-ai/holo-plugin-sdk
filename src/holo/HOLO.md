...
> **Navigation
**: [Main README](../../../../src/providers/README.md) | [Architecture](../../../../src/providers/ARCHITECTURE.md) | [Types](../../../../src/providers/TYPE_REFERENCE.md) | [Translation](../../../../src/providers/TRANSLATION_GUIDE.md) | [Streaming](../../../../src/providers/STREAMING_GUIDE.md)

---

## Overview

**Holo is the canonical portable format** that serves as the hub for all provider translations. It provides a **unified
abstraction layer** over Claude, OpenAI, Ollama, and other LLM providers.
...
- **Note**: The `createStableId()` utility in `utils/index.ts` provides a simple hash-based ID generator (primarily for
  tool calls, but pattern is reusable)
...
**See also:** [GUARD_ERRORS.md](../../../../src/providers/GUARD_ERRORS.md) for complete factory implementation and text
vs JSON mode handling.
...
All error responses follow the same structure as normal responses but with error details in `messages[0].content` (text
mode) or structured `errors` array (JSON mode).
