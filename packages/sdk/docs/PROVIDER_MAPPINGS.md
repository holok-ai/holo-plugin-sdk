...
This document provides comprehensive field-by-field mappings between each provider's native format and the Holo universal format. Use these tables when implementing translation logic in provider plugins.
