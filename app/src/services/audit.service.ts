...
export class AuditService extends ClassLogger {
     ...
     * @param {HoloWorkerRequest | Omit<ProviderRequest, 'id'>} content - Request data to log
     */
    async logRequest(content: HoloWorkerRequest | Omit<ProviderRequest, 'id'>): Promise<void> {
